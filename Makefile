...
build:
	...
	export CARGO_HOME="$(CARGO_HOME)"; export PATH="$(CARGO_PATH)"; cargo build --release
...
test:
	...
	export CARGO_HOME="$(CARGO_HOME)"; export PATH="$(CARGO_PATH)"; cargo test
...
gui:
	...
	export CARGO_HOME="$(CARGO_HOME)"; export PATH="$(CARGO_PATH)"; cargo run -- config-gui

clean:
	export CARGO_HOME="$(CARGO_HOME)"; export PATH="$(CARGO_PATH)"; cargo clean
